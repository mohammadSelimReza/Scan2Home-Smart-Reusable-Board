...
urlpatterns = [
    ...
    path('properties/<uuid:pk>/', views.AdminPropertyDetailView.as_view(), name='admin-property-detail'),
    ...
    path('users/<uuid:pk>/ban/', views.AdminUserBanView.as_view(), name='admin-user-ban'),
    ...
    path('settings/<str:page_type>/', views.StaticPageView.as_view(), name='admin-static-page'),
